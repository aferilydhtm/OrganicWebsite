...
const ScPriceChoiceContainer = class {
  ...
  render() {
    ...
    return (index.h("sc-choice-container", { value: (_a = this.priceData) === null || _a === void 0 ? void 0 : _a.id, type: this.type, showControl: this.showControl, checked: this.checked, onScChange: () => this.scChange.emit() }, index.h("div", { class: "price-choice" }, this.showLabel && (index.h("div", { class: "price-choice__title" }, index.h("div", { class: "price-choice__name" }, this.label || this.priceData.name), !!this.description && index.h("div", { class: "price-choice__description" }, this.description))), this.showPrice && (index.h("div", { class: "price-choice__details" }, index.h("div", { class: "price-choice__price" }, ((_b = this.priceData) === null || _b === void 0 ? void 0 : _b.ad_hoc) ? (wp.i18n.__('Custom Amount', 'surecart')) : (index.h(index.Fragment, null, index.h("sc-format-number", { type: "currency", value: (_c = this.priceData) === null || _c === void 0 ? void 0 : _c.amount, currency: (_d = this.priceData) === null || _d === void 0 ? void 0 : _d.currency }), price.intervalString(this.priceData, {
      showOnce: true,
      abbreviate: true,
      labels: {
        interval: '/',
    ...
    })))), !!((_e = this.priceData) === null || _e === void 0 ? void 0 : _e.trial_duration_days) && (index.h("div", { class: "price-choice__trial" }, wp.i18n.sprintf(wp.i18n._n('Starting in %s day', 'Starting in %s days', this.priceData.trial_duration_days, 'surecart'), this.priceData.trial_duration_days))), !!((_f = this.priceData) === null || _f === void 0 ? void 0 : _f.setup_fee_enabled) && ((_g = this.priceData) === null || _g === void 0 ? void 0 : _g.setup_fee_amount) && (index.h("div", { class: "price-choice__setup-fee" }, index.h("sc-format-number", { type: "currency", value: this.priceData.setup_fee_amount, currency: (_h = this.priceData) === null || _h === void 0 ? void 0 : _h.currency }), ' ', ((_j = this.priceData) === null || _j === void 0 ? void 0 : _j.setup_fee_name) || wp.i18n.__('Setup Fee', 'surecart'))))))));
  }
