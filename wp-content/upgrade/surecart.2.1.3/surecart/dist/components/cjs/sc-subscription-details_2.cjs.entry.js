...
const ScSubscriptionDetails = class {
  ...
  renderRenewalText() {
    ...
    if (((_a = this === null || this === void 0 ? void 0 : this.subscription) === null || _a === void 0 ? void 0 : _a.cancel_at_period_end) && ((_b = this === null || this === void 0 ? void 0 : this.subscription) === null || _b === void 0 ? void 0 : _b.current_period_end_at)) {
      return (index.h("span", null, tag, " ", wp.i18n.sprintf(wp.i18n.__('Your plan will be canceled on', 'surecart')), ' ', index.h("sc-format-date", { date: this.subscription.current_period_end_at * 1000, month: "long", day: "numeric", year: "numeric" })));
    }
    if (this.hasPendingUpdate) {
      ...
      if ((_f = (_e = this.subscription) === null || _e === void 0 ? void 0 : _e.pending_update) === null || _f === void 0 ? void 0 : _f.ad_hoc_amount) {
        return (index.h("span", null, wp.i18n.__('Your plan switches to', 'surecart'), ' ', index.h("strong", null, index.h("sc-format-number", { type: "currency", currency: ((_g = this.pendingPrice) === null || _g === void 0 ? void 0 : _g.currency) || ((_j = (_h = this.subscription) === null || _h === void 0 ? void 0 : _h.price) === null || _j === void 0 ? void 0 : _j.currency), value: (_l = (_k = this.subscription) === null || _k === void 0 ? void 0 : _k.pending_update) === null || _l === void 0 ? void 0 : _l.ad_hoc_amount }), ' ', price.intervalString(this.pendingPrice || ((_m = this.subscription) === null || _m === void 0 ? void 0 : _m.price))), ' ', wp.i18n.__('on', 'surecart'), ' ', index.h("sc-format-date", { date: this.subscription.current_period_end_at, type: "timestamp", month: "long", day: "numeric", year: "numeric" })));
      }
      return (index.h("span", null, wp.i18n.__('Your plan switches to', 'surecart'), " ", index.h("strong", null, this.pendingPrice.product.name), " ", wp.i18n.__('on', 'surecart'), ' ', index.h("sc-format-date", { date: this.subscription.current_period_end_at, type: "timestamp", month: "long", day: "numeric", year: "numeric" })));
    }
    if (((_o = this === null || this === void 0 ? void 0 : this.subscription) === null || _o === void 0 ? void 0 : _o.status) === 'trialing' && ((_p = this === null || this === void 0 ? void 0 : this.subscription) === null || _p === void 0 ? void 0 : _p.trial_end_at)) {
      return (index.h("span", null, tag, " ", wp.i18n.sprintf(wp.i18n.__('Your plan begins on', 'surecart')), ' ', index.h("sc-format-date", { date: (_q = this === null || this === void 0 ? void 0 : this.subscription) === null || _q === void 0 ? void 0 : _q.trial_end_at, type: "timestamp", month: "long", day: "numeric", year: "numeric" })));
    }
    if (((_r = this.subscription) === null || _r === void 0 ? void 0 : _r.status) === 'active' && ((_s = this.subscription) === null || _s === void 0 ? void 0 : _s.current_period_end_at)) {
      return (index.h("span", null, tag, " ", ((_t = this.subscription) === null || _t === void 0 ? void 0 : _t.remaining_period_count) === null ? wp.i18n.__('Your plan renews on', 'surecart') : wp.i18n.__('Your next payment is on', 'surecart'), ' ', index.h("sc-format-date", { date: (_u = this === null || this === void 0 ? void 0 : this.subscription) === null || _u === void 0 ? void 0 : _u.current_period_end_at, type: "timestamp", month: "long", day: "numeric", year: "numeric" })));
    }
    return tag;
  }
  getActivations() {
  ...
  render() {
    return (index.h("div", { class: "subscription-details" }, this.hasPendingUpdate && (index.h("div", null, index.h("sc-tag", { size: "small", type: "warning" }, wp.i18n.__('Update Scheduled', 'surecart')))), index.h("sc-flex", { alignItems: "center", justifyContent: "flex-start" }, index.h("sc-text", { style: { '--font-weight': 'var(--sc-font-weight-bold)' } }, this.renderName()), this.renderActivations()), !this.hideRenewalText && index.h("div", null, this.renderRenewalText(), " "), index.h("slot", null), index.h("sc-dialog", { label: wp.i18n.__('Activations', 'surecart'), onScRequestClose: () => (this.activationsModal = false), open: !!this.activationsModal }, index.h("sc-card", { "no-padding": true, style: { '--overflow': 'hidden' } }, index.h("sc-stacked-list", null, (this.getActivations() || []).map(activation => {
...
const ScSubscriptionStatusBadge = class {
  ...
  render() {
    return index.h("sc-tag", { type: this.getType() }, this.getText());
  }
};
