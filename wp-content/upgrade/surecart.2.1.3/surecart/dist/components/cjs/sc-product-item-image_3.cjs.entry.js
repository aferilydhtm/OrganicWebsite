...
const ScProductItemImage = class {
  constructor(hostRef) {
    ...
    this.productMedia = undefined;
    this.alt = undefined;
    this.sizing = undefined;
  }
  getSrc() {
    var _a, _b, _c, _d, _e, _f;
    if ((_a = this.productMedia) === null || _a === void 0 ? void 0 : _a.url) {
      return (_b = this.productMedia) === null || _b === void 0 ? void 0 : _b.url;
    }
    if ((_d = (_c = this.productMedia) === null || _c === void 0 ? void 0 : _c.media) === null || _d === void 0 ? void 0 : _d.url) {
      return media.sizeImage((_f = (_e = this.productMedia) === null || _e === void 0 ? void 0 : _e.media) === null || _f === void 0 ? void 0 : _f.url, index$1.applyFilters('surecart/product-list/media/size', 900));
    }
    return '';
  }
  render() {
    return (index.h(index.Host, { style: { borderStyle: 'none' } }, index.h("div", { class: {
      ...
      } }, !!this.getSrc() ? index.h("img", { src: this.getSrc(), alt: this.alt }) : index.h("div", { class: "product-img_placeholder" }))));
  }
};
