...
const ScOrderConfirmation = class {
  ...
  getSessionId() {
    ...
    return getQueryArg.getQueryArg(window.location.href, 'order');
  }
  /** Update a session */
  async getSession() {
    var _a;
  ...
  renderManualInstructions() {
    ...
    if (!(paymentMethod === null || paymentMethod === void 0 ? void 0 : paymentMethod.instructions))
      return;
    return (index.h("sc-alert", { type: "info", open: true }, index.h("span", { slot: "title" }, paymentMethod === null || paymentMethod === void 0 ? void 0 : paymentMethod.name), paymentMethod === null || paymentMethod === void 0 ? void 0 :
