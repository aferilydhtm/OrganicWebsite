...
const ScFormControl = class {
  ...
  handleErrors() {
    var _a;
    this.errorMessage = (_a = this === null || this === void 0 ? void 0 : this.errors) === null || _a === void 0 ? void 0 : _a[this === null || this === void 0 ? void 0 : this.name];
  }
  render() {
    return (index.h("div", { part: "form-control", class: {
      ...
      } }, index.h("label", { part: "label", id: this.labelId, class: "form-control__label", htmlFor: this.inputId, "aria-hidden": !!this.label ? 'false' : 'true' }, index.h("slot", { name: "label" }, this.label), index.h("slot", { name: "label-end" })), index.h("div", { part: "input", class: "form-control__input" }, !!this.errorMessage ? (index.h("sc-tooltip", { exportparts: "base:tooltip, text:tooltip-text", text: this.errorMessage, type: "danger", padding: 10, freeze: true, open: true, onClick: () => (this.errorMessage = '') }, index.h("slot", null))) : (index.h("slot", null))), this.help && (index.h("div", { part: "help-text", id: this.helpId, class: "form-control__help-text" }, index.h("slot", { name: "help-text" }, this.help)))));
  }
...
consumer.openWormhole(ScFormControl, ['errors'], false);
...
const ScInput = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { hidden: this.hidden }, index.h("sc-form-control", { exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, showLabel: this.showLabel, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, index.h("slot", { name: "label-end", slot: "label-end" }), index.h("div", { part: "base", class: {
      ...
      autocomplete: this.autocomplete, autocorrect: this.autocorrect, autofocus: this.autofocus, spellcheck: this.spellcheck, pattern: this.pattern, inputmode: this.inputmode, "aria-labelledby": this.label, "aria-invalid": this.invalid ? true : false, value: this.value, onChange: () => this.handleChange(), onInput: () => this.handleInput(),
