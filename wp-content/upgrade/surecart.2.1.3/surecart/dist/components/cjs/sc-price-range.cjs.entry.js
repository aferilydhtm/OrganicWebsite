...
const ScPriceRange = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, this.maxPrice.amount == this.minPrice.amount ? (index.h("span", null, index.h("sc-format-number", { type: "currency", currency: this.maxPrice.currency, value: this.maxPrice.amount }))) : (index.h("span", null, index.h("sc-format-number", { type: "currency", currency: this.minPrice.currency, value: this.minPrice.amount }), " ", ' - ', index.h("sc-format-number", { type: "currency", currency: this.maxPrice.currency, value: this.maxPrice.amount })))));
  }
