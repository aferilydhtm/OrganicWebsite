...
const ScImageSlider = class {
  ...
  render() {
    ...
    return (index.h("div", { class: { 'image-slider': true, 'image-slider--is-fixed-height': !this.autoHeight }, part: "base" }, index.h("div", { class: "swiper", ref: el => (this.swiperContainerRef = el) }, index.h("div", { class: "swiper-wrapper" }, (this.imagesData || []).map(({ src, alt, srcset, width, height, sizes }, index$1) => (index.h("div", { key: index$1, class: "swiper-slide image-slider__slider" }, index.h("div", { class: "swiper-slide-img" }, index.h("img", { src: src, alt: alt, srcset: srcset, width: width, height: height, sizes: sizes, loading: index$1 > 0 ? 'lazy' : 'eager' }))))))), this.hasThumbnails && (index.h("div", { class: { 'image-slider__thumbs': true, 'image-slider__thumbs--has-navigation': this.images.length > 5 } }, index.h("div", { class: "image-slider__navigation image-slider--is-prev", ref: el => (this.previous = el) }, index.h("sc-icon", { name: "chevron-left" })), index.h("div", { class: "swiper", ref: el => (this.swiperThumbsRef = el) }, index.h("div", { class: "swiper-wrapper" }, (thumbnails || []).map(({ src, alt, srcset, width, height, sizes }, index$1) => (index.h("div", { class: { 'swiper-slide': true, 'image-slider__thumb': true, 'image-slider__thumb--is-active': this.currentSliderIndex === index$1 }, onClick: () => { var _a, _b; return (_b = (_a = this.swiper) === null || _a === void 0 ? void 0 : _a.slideTo) === null || _b === void 0 ? void 0 : _b.call(_a, index$1); } }, index.h("img", { src: src, alt: alt, srcset: srcset, width: width, height: height, sizes: sizes, loading: index$1 > this.thumbnailsPerPage - 1 ? 'lazy' : 'eager' })))))), index.h("div", { class: "image-slider__navigation image-slider--is-next", ref: el => (this.next = el) }, index.h("sc-icon", { name: "chevron-right" }))))));
  }
