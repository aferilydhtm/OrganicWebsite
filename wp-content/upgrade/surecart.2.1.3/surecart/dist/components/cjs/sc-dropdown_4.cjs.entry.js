...
const ScDropdown = class {
  ...
  render() {
    return (index.h("div", { part: "base", class: {
      ...
      }, "aria-expanded": "true", "aria-haspopup": "true" }, index.h("slot", { name: "trigger" })), index.h("div", { class: "dropdown__positioner", ref: el => (this.positioner = el) }, index.h("div", { part: "panel", class: {
      ...
      }, role: "menu", "aria-orientation": "vertical", "aria-labelledby": "menu-button", tabindex: "-1", onClick: e => this.handleClick(e), ref: el => (this.panel = el) }, index.h("slot", null)))));
  }
