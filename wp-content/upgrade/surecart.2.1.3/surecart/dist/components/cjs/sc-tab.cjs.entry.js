...
const ScTab = class {
  ...
  render() {
    ...
    return (index.h(Tag, { part: `base ${this.active ? `active` : ``}`, href: this.href, class: {
      ...
      }, ref: el => (this.tab = el), role: "tab", "aria-disabled": this.disabled ? 'true' : 'false', "aria-selected": this.active ? 'true' : 'false', tabindex: this.disabled || !this.active ? '-1' : '0' }, index.h("span", { part: "prefix", class: "tab__prefix" }, index.h("slot", { onSlotchange: () => this.handleSlotChange(), name: "prefix" })), index.h("div", { class: "tab__content", part: "content" }, index.h("slot", null)), index.h("span", { part: "suffix", class: "tab__suffix" }, index.h("slot", { onSlotchange: () => this.handleSlotChange(), name: "suffix" })), index.h("slot", { name: "suffix" }, !!this.count && (index.h("div", { class: "tab__counter", part: "counter" }, this.count)))));
  }
