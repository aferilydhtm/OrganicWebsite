...
import { b as getCheckout, c as store$1 } from './watchers-9ca21ceb.js';
...
const ScCartButton = class {
  ...
  componentDidLoad() {
    ...
    store$1.onChange(this.mode, () => this.handleParentLinkDisplay());
  }
  handleParentLinkDisplay() {
    this.link.style.display = !this.cartMenuAlwaysShown && !this.getItemsCount() ? 'none' : null;
  }
  render() {
    return (h("div", { class: "cart__button", part: "base" }, h("div", { class: "cart__content" }, (this.showEmptyCount || !!this.getItemsCount()) && (h("span", { class: "cart__count", part: "count" }, this.getItemsCount())), h("div", { class: "cart__icon" }, h("slot", null)))));
  }
