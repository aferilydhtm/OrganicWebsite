...
const ScProductItemImage = class {
  ...
  getSrc() {
    ...
    if ((_d = (_c = this.productMedia) === null || _c === void 0 ? void 0 : _c.media) === null || _d === void 0 ? void 0 : _d.url) {
      return sizeImage((_f = (_e = this.productMedia) === null || _e === void 0 ? void 0 : _e.media) === null || _f === void 0 ? void 0 : _f.url, applyFilters('surecart/product-list/media/size', 900));
    }
    return '';
  }
  render() {
    return (h(Host, { style: { borderStyle: 'none' } }, h("div", { class: {
      ...
      } }, !!this.getSrc() ? h("img", { src: this.getSrc(), alt: this.alt }) : h("div", { class: "product-img_placeholder" }))));
  }
};
