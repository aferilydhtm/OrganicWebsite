...
import { i as isValidURL } from './util-c1d762c0.js';
import { g as getType, z as zones } from './tax-83f264de.js';
...
const ScSelectDropdown = class {
  ...
  renderItem(choice, index) {
    ...
    return (h("sc-menu-item", { key: index, checked: this.isChecked(choice), value: choice === null || choice === void 0 ? void 0 : choice.value, onClick: () => !choice.disabled && this.handleSelect(choice.value), disabled: choice.disabled }, choice.label, !!(choice === null || choice === void 0 ? void 0 : choice.suffix) && h("span", { slot: "suffix" }, choice.suffix), !!(choice === null || choice === void 0 ? void 0 : choice.icon) && this.renderIcon(choice.icon)));
  }
  render() {
    var _a;
    return (h("div", { part: "base", class: {
      ...
      } }, h("sc-form-control", { exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, h("input", { class: "select__hidden-input", onBlur: () => this.handleBlur(), onFocus: () => this.handleFocus(), name: this.name, ref: el => (this.input = el), value: this.value, required: this.required, disabled: this.disabled }), h("sc-dropdown", { exportparts: "trigger, panel", disabled: this.disabled, open: this.open, position: this.position, placement: this.placement, hoist: this.hoist, style: { '--panel-width': '100%' }, onScShow: () => this.handleShow(), onScHide: () => this.handleHide() }, h("div", { class: "trigger", slot: "trigger" }, h("div", { class: "select__value" }, this.displayValue() || this.placeholder || 'Select...'), h("sc-icon", { exportparts: "base:caret", class: "select__caret", name: "chevron-down" })), this.search && (h("sc-input", { exportparts: "base:search__base, input:search__input, form-control:search__form-control", placeholder: this.searchPlaceholder || 'Search...', onScInput: e => this.handleQuery(e), class: "search", clearable: true, part: "search", ref: el => (this.searchInput = el) }, this.loading && h("sc-spinner", { exportparts: "base:spinner__base", style: { '--spinner-size': '0.5em' }, slot: "suffix" }))), h("sc-menu", { style: { maxHeight: '210px', overflow: 'auto' }, exportparts: "base:menu__base", onScroll: e => this.handleMenuScroll(e) }, h("slot", { name: "prefix" }), (this.filteredChoices || []).map((choice, index) => {
...
const ScTaxIdInput = class {
  ...
  render() {
    var _a, _b;
    return (h(Fragment, null, h("sc-input", { name: "tax_identifier.number_type", value: this.type, style: { display: 'none' } }), h("sc-input", { label: (_a = zones === null || zones === void 0 ? void 0 : zones[(this === null || this === void 0 ? void 0 : this.type) || 'other']) === null || _a === void 0 ? void 0 : _a.label, name: "tax_identifier.number", value: this.number, onScInput: (e) => {
      ...
      } }, this.loading && this.type === 'eu_vat' ? h("sc-spinner", { slot: "prefix", style: { '--spinner-size': '10px' } }) : this.renderStatus(), h("sc-dropdown", { slot: "suffix", position: "bottom-right" }, h("sc-button", { type: "text", slot: "trigger", caret: true, loading: false, style: { color: 'var(--sc-input-label-color)' } }, (_b = zones === null || zones === void 0 ? void 0 : zones[(this === null || this === void 0 ? void 0 : this.type) || 'other']) === null || _b === void 0 ? void 0 : _b.label_small), h("sc-menu", null, Object.keys(zones || {}).map(name => (h("sc-menu-item", { onClick: () => {
        this.scInput.emit({
          number: this.number,
          number_type: name,
        });
        ...
        this.type = name;
      }, checked: this.type === name }, zones[name].label_small))))))));
  }
  static get watchers() { return {
...
export { ScAddress as sc_address, ScSelectDropdown as sc_select, ScTaxIdInput as sc_tax_id_input };
