...
const ScDropdown = class {
  ...
  render() {
    return (h("div", { part: "base", class: {
      ...
      }, "aria-expanded": "true", "aria-haspopup": "true" }, h("slot", { name: "trigger" })), h("div", { class: "dropdown__positioner", ref: el => (this.positioner = el) }, h("div", { part: "panel", class: {
      ...
      }, role: "menu", "aria-orientation": "vertical", "aria-labelledby": "menu-button", tabindex: "-1", onClick: e => this.handleClick(e), ref: el => (this.panel = el) }, h("slot", null)))));
  }
...
const ScMenu = class {
  ...
  render() {
    return (h("div", { part: "base", class: "menu", role: "menu", tabindex: "0", onKeyDown: e => this.handleKeyDown(e) }, h("slot", { onSlotchange: () => this.handleSlotChange() })));
  }
  get el() { return getElement(this); }
};
