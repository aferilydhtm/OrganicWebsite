...
const ScSubscription = class {
  ...
  render() {
    var _a, _b, _c, _d;
    return (h("sc-dashboard-module", { heading: this.heading || wp.i18n.__('Current Plan', 'surecart'), class: "subscription", error: this.error }, !!this.subscription && (h("sc-flex", { slot: "end" }, getQueryArg(window.location.href, 'action') !== 'update_payment_method' && (h("sc-button", { type: "link", href: addQueryArgs(window.location.href, {
