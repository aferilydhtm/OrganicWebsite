      ...
      (this.layoutConfig || []).map(layout => {
        ...
        switch (layout.blockName) {
          ...
          case 'surecart/product-item-image':
            return h("sc-product-item-image", { part: "image", productMedia: (_d = (_c = (_b = this.product) === null || _b === void 0 ? void 0 : _b.product_medias) === null || _c === void 0 ? void 0 : _c.data) === null || _d === void 0 ? void 0 : _d[0], sizing: (_e = layout.attributes) === null || _e === void 0 ? void 0 : _e.sizing });
          case 'surecart/product-item-price':
            return h("sc-product-item-price", { part: "price", prices: (_f = this.product) === null || _f === void 0 ? void 0 : _f.prices.data, range: !!(attributes === null || attributes === void 0 ? void 0 : attributes.range) });
          default:
            return null;
        }
      })));
