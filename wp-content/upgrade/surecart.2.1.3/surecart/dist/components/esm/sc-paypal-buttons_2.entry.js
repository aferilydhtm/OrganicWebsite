...
import { d as fetchCheckout } from './index-813122a4.js';
  ...
  renderButtons(paypal) {
    ...
    const config = {
      ...
      onApprove: async () => {
        ...
        try {
          ...
          console.error(e);
          this.scError.emit({ code: 'could_not_capture', message: wp.i18n.__('The payment did not process. Please try again.', 'surecart') });
          this.scSetState.emit('REJECT');
        }
        try {
    ...
    config[createFunc] = async () => {
      return new Promise(async (resolve, reject) => {
        ...
        this.scError.emit({ code: 'missing_payment_intent', message: wp.i18n.__('Something went wrong. Please contact us for payment.', 'surecart') });
        return reject();
      });
    };
