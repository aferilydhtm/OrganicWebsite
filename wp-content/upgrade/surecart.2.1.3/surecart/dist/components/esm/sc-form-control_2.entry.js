...
const ScFormControl = class {
  ...
  render() {
    return (h("div", { part: "form-control", class: {
      ...
      } }, h("label", { part: "label", id: this.labelId, class: "form-control__label", htmlFor: this.inputId, "aria-hidden": !!this.label ? 'false' : 'true' }, h("slot", { name: "label" }, this.label), h("slot", { name: "label-end" })), h("div", { part: "input", class: "form-control__input" }, !!this.errorMessage ? (h("sc-tooltip", { exportparts: "base:tooltip, text:tooltip-text", text: this.errorMessage, type: "danger", padding: 10, freeze: true, open: true, onClick: () => (this.errorMessage = '') }, h("slot", null))) : (h("slot", null))), this.help && (h("div", { part: "help-text", id: this.helpId, class: "form-control__help-text" }, h("slot", { name: "help-text" }, this.help)))));
  }
