...
const ScPasswordNag = class {
  ...
  render() {
    ...
    return (h("sc-alert", { type: this.type, open: this.open, exportparts: "base, icon, text, title, message, close-icon", style: { position: 'relative' } }, !!this.error && this.error, this.set ? (h("sc-dashboard-module", { class: "customer-details" }, h("span", { slot: "heading" }, wp.i18n.__('Set A Password', 'surecart'), " "), h("sc-button", { type: "text", size: "small", slot: "end", onClick: () => (this.set = false) }, h("sc-icon", { name: "x", slot: "prefix" }), wp.i18n.__('Cancel', 'surecart')), h("sc-card", null, h("sc-form", { onScFormSubmit: e => this.handleSubmit(e) }, h("sc-input", { label: wp.i18n.__('New Password', 'surecart'), name: "password", type: "password", required: true, ref: el => (this.input = el) }), h("sc-input", { label: wp.i18n.__('Confirm New Password', 'surecart'), name: "password_confirm", type: "password", required: true }), h("div", null, h("sc-button", { type: "primary", full: true, submit: true, busy: this.loading }, wp.i18n.__('Update Password', 'surecart'))))))) : (h(Fragment, null, h("slot", { name: "title", slot: "title" }, wp.i18n.__('Reminder', 'surecart')), h("slot", null, wp.i18n.__('You have not yet set a password. Please set a password for your account.', 'surecart')), h("sc-flex", { "justify-content": "flex-start" }, h("sc-button", { size: "small", type: "primary", onClick: () => (this.set = true) }, wp.i18n.__('Set A Password', 'surecart')), h("sc-button", { size: "small", type: "text", onClick: () => this.dismiss() }, wp.i18n.__('Dismiss', 'surecart'))))), this.loading && h("sc-block-ui", { spinner: true })));
  }
