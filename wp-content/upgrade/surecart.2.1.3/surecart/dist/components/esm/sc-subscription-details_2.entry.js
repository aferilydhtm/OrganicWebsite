...
const ScSubscriptionDetails = class {
  ...
  renderRenewalText() {
    ...
    if (((_a = this === null || this === void 0 ? void 0 : this.subscription) === null || _a === void 0 ? void 0 : _a.cancel_at_period_end) && ((_b = this === null || this === void 0 ? void 0 : this.subscription) === null || _b === void 0 ? void 0 : _b.current_period_end_at)) {
      return (h("span", null, tag, " ", wp.i18n.sprintf(wp.i18n.__('Your plan will be canceled on', 'surecart')), ' ', h("sc-format-date", { date: this.subscription.current_period_end_at * 1000, month: "long", day: "numeric", year: "numeric" })));
    }
    if (this.hasPendingUpdate) {
      ...
      if ((_f = (_e = this.subscription) === null || _e === void 0 ? void 0 : _e.pending_update) === null || _f === void 0 ? void 0 : _f.ad_hoc_amount) {
        return (h("span", null, wp.i18n.__('Your plan switches to', 'surecart'), ' ', h("strong", null, h("sc-format-number", { type: "currency", currency: ((_g = this.pendingPrice) === null || _g === void 0 ? void 0 : _g.currency) || ((_j = (_h = this.subscription) === null || _h === void 0 ? void 0 : _h.price) === null || _j === void 0 ? void 0 : _j.currency), value: (_l = (_k = this.subscription) === null || _k === void 0 ? void 0 : _k.pending_update) === null || _l === void 0 ? void 0 : _l.ad_hoc_amount }), ' ', intervalString(this.pendingPrice || ((_m = this.subscription) === null || _m === void 0 ? void 0 : _m.price))), ' ', wp.i18n.__('on', 'surecart'), ' ', h("sc-format-date", { date: this.subscription.current_period_end_at, type: "timestamp", month: "long", day: "numeric", year: "numeric" })));
      }
      return (h("span", null, wp.i18n.__('Your plan switches to', 'surecart'), " ", h("strong", null, this.pendingPrice.product.name), " ", wp.i18n.__('on', 'surecart'), ' ', h("sc-format-date", { date: this.subscription.current_period_end_at, type: "timestamp", month: "long", day: "numeric", year: "numeric" })));
    }
    if (((_o = this === null || this === void 0 ? void 0 : this.subscription) === null || _o === void 0 ? void 0 : _o.status) === 'trialing' && ((_p = this === null || this === void 0 ? void 0 : this.subscription) === null || _p === void 0 ? void 0 : _p.trial_end_at)) {
      return (h("span", null, tag, " ", wp.i18n.sprintf(wp.i18n.__('Your plan begins on', 'surecart')), ' ', h("sc-format-date", { date: (_q = this === null || this === void 0 ? void 0 : this.subscription) === null || _q === void 0 ? void 0 : _q.trial_end_at, type: "timestamp", month: "long", day: "numeric", year: "numeric" })));
    }
  ...
  render() {
    return (h("div", { class: "subscription-details" }, this.hasPendingUpdate && (h("div", null, h("sc-tag", { size: "small", type: "warning" }, wp.i18n.__('Update Scheduled', 'surecart')))), h("sc-flex", { alignItems: "center", justifyContent: "flex-start" }, h("sc-text", { style: { '--font-weight': 'var(--sc-font-weight-bold)' } }, this.renderName()), this.renderActivations()), !this.hideRenewalText && h("div", null, this.renderRenewalText(), " "), h("slot", null), h("sc-dialog", { label: wp.i18n.__('Activations', 'surecart'), onScRequestClose: () => (this.activationsModal = false), open: !!this.activationsModal }, h("sc-card", { "no-padding": true, style: { '--overflow': 'hidden' } }, h("sc-stacked-list", null, (this.getActivations() || []).map(activation => {
