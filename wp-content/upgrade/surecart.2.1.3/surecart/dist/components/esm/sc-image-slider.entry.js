...
const ScImageSlider = class {
  ...
  render() {
    ...
    return (h("div", { class: { 'image-slider': true, 'image-slider--is-fixed-height': !this.autoHeight }, part: "base" }, h("div", { class: "swiper", ref: el => (this.swiperContainerRef = el) }, h("div", { class: "swiper-wrapper" }, (this.imagesData || []).map(({ src, alt, srcset, width, height, sizes }, index) => (h("div", { key: index, class: "swiper-slide image-slider__slider" }, h("div", { class: "swiper-slide-img" }, h("img", { src: src, alt: alt, srcset: srcset, width: width, height: height, sizes: sizes, loading: index > 0 ? 'lazy' : 'eager' }))))))), this.hasThumbnails && (h("div", { class: { 'image-slider__thumbs': true, 'image-slider__thumbs--has-navigation': this.images.length > 5 } }, h("div", { class: "image-slider__navigation image-slider--is-prev", ref: el => (this.previous = el) }, h("sc-icon", { name: "chevron-left" })), h("div", { class: "swiper", ref: el => (this.swiperThumbsRef = el) }, h("div", { class: "swiper-wrapper" }, (thumbnails || []).map(({ src, alt, srcset, width, height, sizes }, index) => (h("div", { class: { 'swiper-slide': true, 'image-slider__thumb': true, 'image-slider__thumb--is-active': this.currentSliderIndex === index }, onClick: () => { var _a, _b; return (_b = (_a = this.swiper) === null || _a === void 0 ? void 0 : _a.slideTo) === null || _b === void 0 ? void 0 : _b.call(_a, index); } }, h("img", { src: src, alt: alt, srcset: srcset, width: width, height: height, sizes: sizes, loading: index > this.thumbnailsPerPage - 1 ? 'lazy' : 'eager' })))))), h("div", { class: "image-slider__navigation image-slider--is-next", ref: el => (this.next = el) }, h("sc-icon", { name: "chevron-right" }))))));
  }
